...
class MissileConfig:
    ...
    navigation_constant: SourcedValue = field(default_factory=lambda: sv(3.0, PAPER_ENGINEERING))
    maximum_overload_g: SourcedValue = field(default_factory=lambda: sv(30.0, PAPER_ENGINEERING))
