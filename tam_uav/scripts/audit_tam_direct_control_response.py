...
def _telemetry(env, agent_id: str, step: int, origin: np.ndarray) -> dict:
    ...
    return {
        ...
        **command,
        "fcs_surface": {
            "aileron": _property(sim, "fcs/aileron-pos-norm", "fcs/left-aileron-pos-norm"),
            "elevator": _property(sim, "fcs/elevator-pos-norm"),
            "rudder": _property(sim, "fcs/rudder-pos-norm"),
        },
