...
def main():
    ...
    p.add_argument("--output-acmi", default="outputs/acmi/paper_aligned_brma_rule_no_mav_trim_3v2_episode0.acmi")
    p.add_argument("--output-summary", default="outputs/acmi/paper_aligned_brma_rule_no_mav_trim_3v2_episode0_summary.json")
    args = p.parse_args()
    ...
    while not done:
        ...
        opp = OpponentPolicy(mode="brma_rule", seed=frame)
