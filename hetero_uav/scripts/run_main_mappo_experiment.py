...
def run_experiment(spec: ExperimentSpec) -> None:
    ...
    for rec in eval_data:
        summary_records.append({
            ...
            "red_elimination_win_rate": rec.get("red_elimination_win_rate", 0.0),
            "blue_elimination_win_rate": rec.get("blue_elimination_win_rate", 0.0),
            "red_timeout_alive_advantage_rate": rec.get("red_timeout_alive_advantage_rate", 0.0),
            "blue_timeout_alive_advantage_rate": rec.get("blue_timeout_alive_advantage_rate", 0.0),
            "timeout_draw_rate": rec.get("timeout_draw_rate", 0.0),
            "kill_death_ratio": rec.get("kill_death_ratio", 0.0),
            ...
            "red_dead_final_mean": rec.get("red_dead_final_mean", 0.0),
            "blue_dead_final_mean": rec.get("blue_dead_final_mean", 0.0),
...
def main() -> None:
    ...
    parser.add_argument("--opponent-policy", choices=["rule_nearest", "greedy_fsm", "brma_rule", "tam_greedy_easy", "brma_rule_safe_pursuit_easy", "fixed_route"], default="greedy_fsm")
