"""Run a short opt-in BRMA-style entity encoder HAPPO smoke test.

This runner only checks rollout, PPO update, checkpoint save, and eval loading.
It does not enable GRU, random masks, biased masks, init checkpoints, or
imitation datasets.
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="outputs/debug_brma_entity_smoke")
