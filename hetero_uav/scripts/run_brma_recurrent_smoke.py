"""Run a short opt-in BRMA-style recurrent GRU actor smoke test.

This runner only checks rollout, PPO update, checkpoint save, and eval loading
with the recurrent policy.  It does not enable GRU in critic, random masks,
biased masks, or imitation datasets.
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="outputs/debug_brma_recurrent_smoke")
