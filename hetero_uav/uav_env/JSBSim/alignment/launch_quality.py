...
LAUNCH_QUALITY_FIELDS = (
    ...
    "shooter_num_left_before_launch",
...
def make_launch_quality_record(
    *,
    ...
    target_role: str = "",
    target_model: str = "",
    shooter_num_left_before_launch: int | str = "",
    shooter_num_left_after_launch: int | str = "",
) -> dict:
    record = {field: "" for field in LAUNCH_QUALITY_FIELDS}
    record.update({
        "team": team,
        "shooter_team": shooter_team or team,
        ...
        "shooter_num_left_before_launch": shooter_num_left_before_launch,
        "shooter_num_left_after_launch": shooter_num_left_after_launch,
        "termination_reason": "",
        "is_success": False,
