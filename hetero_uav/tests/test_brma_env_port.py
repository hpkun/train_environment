...
def test_brma_env_import_does_not_load_parent_package():
...
def test_brma_env_reset_and_random_step():
    from uav_env.brma_env.env import UavCombatEnv
...
def test_aircraft_simulator_loads_f16():
    from uav_env.brma_env.simulator import AircraftSimulator
...
def test_missile_simulator_can_be_created():
    from uav_env.brma_env.simulator import AircraftSimulator, MissileSimulator
