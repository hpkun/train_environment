...
render = True
# 【修改】根据训练代数更新
ego_policy_index = 169 #我方 蓝色 1040代
enm_policy_index = 2 #敌方 红色 初代乱飞
episode_rewards = 0
# 【修改】训练模型路径
exact_model_dir = "/Users/yuanyuan/Desktop/github-RL/CloseAirCombat-master/CloseAirCombat-master/scripts/results/SingleCombat/1v1/ShootMissile/HierarchySelfplay/ppo/v1/run1"
ego_run_dir = exact_model_dir 
enm_run_dir = exact_model_dir
